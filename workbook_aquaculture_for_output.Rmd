...
time_of_the_day_number = seq(0, 21, 3)
time_of_the_day = c("hour0", "hour3", "hour6", "hour9", "hour12", "hour15", "hour18", "hour21")
...
days_2018_to_2019 = rep(365, 2)
# (cumsum_days = cumsum(days_2017_to_2019))
(cumsum_days = cumsum(days_2018_to_2019))
# all_years = seq(2017,2019,1)
all_years = seq(2018,2019,1)
...
all_data = all_data %>% mutate(SRAD00 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h0[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h0[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h0[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h0[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h0[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h0[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h0[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h0[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h0[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h0[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h0[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h0[12],
  ))

all_data = all_data %>% mutate(SRAD03 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h3[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h3[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h3[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h3[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h3[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h3[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h3[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h3[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h3[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h3[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h3[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h3[12],
  ))

all_data = all_data %>% mutate(SRAD06 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h6[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h6[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h6[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h6[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h6[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h6[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h6[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h6[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h6[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h6[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h6[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h6[12],
  ))


all_data = all_data %>% mutate(SRAD09 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h9[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h9[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h9[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h9[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h9[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h9[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h9[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h9[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h9[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h9[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h9[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h9[12],
  ))

all_data = all_data %>% mutate(SRAD12 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h12[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h12[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h12[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h12[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h12[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h12[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h12[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h12[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h12[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h12[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h12[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h12[12],
  ))

all_data = all_data %>% mutate(SRAD15 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h15[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h15[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h15[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h15[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h15[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h15[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h15[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h15[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h15[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h15[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h15[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h15[12],
  ))

all_data = all_data %>% mutate(SRAD18 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h18[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h18[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h18[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h18[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h18[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h18[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h18[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h18[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h18[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h18[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h18[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h18[12],
  ))

all_data = all_data %>% mutate(SRAD21 = case_when(
  month == 1 ~ SRAD * daily_to_three_hourly$h21[1],
  month == 2 ~ SRAD * daily_to_three_hourly$h21[2],
  month == 3 ~ SRAD * daily_to_three_hourly$h21[3],
  month == 4 ~ SRAD * daily_to_three_hourly$h21[4],
  month == 5 ~ SRAD * daily_to_three_hourly$h21[5],
  month == 6 ~ SRAD * daily_to_three_hourly$h21[6],
  month == 7 ~ SRAD * daily_to_three_hourly$h21[7],
  month == 8 ~ SRAD * daily_to_three_hourly$h21[8],
  month == 9 ~ SRAD * daily_to_three_hourly$h21[9],
  month == 10 ~ SRAD * daily_to_three_hourly$h21[10],
  month == 11 ~ SRAD * daily_to_three_hourly$h21[11],
  month == 12 ~ SRAD * daily_to_three_hourly$h21[12],
  ))
...
```{r}
calculate_phi_s(1, 4, 1, 1)
```

```{r}
radiation_column_names = colnames(read_met_data(1, 1))[-c(1,2,3,4,5,6,7,8)]
```
...
```{r}
calculate_phi_at = function(three_hour, cloud_fraction, day_arg, year_arg){
  # Get the time in hour
  hour = time_of_the_day_number[three_hour]
  ...
  air_temp = air_temp[air_temp$area == areas[2], ] 
...
```{r}
calculate_phi_at(4, 0.3, 1, 2017)
```

### Calculate phi_ws

```{r}
calculate_phi_ws = function(three_hour, day_arg, year_arg){
  # T_wk is the water surface temperature in Kelvin
  
  # The following file heat_layers.csv contains the output of the simulation
  heat_layers = read.csv("simulated_data_for_output.csv")
  ...
  T_wk = heat_layers$water_temp + 273.15
...
```{r}
calculate_phi_ws(4, 1, 2017)
```

### Calculate phi_e

```{r}
calculate_phi_e = function(i, three_hour, day_arg, year_arg){
  
  # N, empirical coefficient from Lake Hefner, unit KJm-2km-1mmHg-1
  N = 5.0593
  
  daily_data = read_met_data(i, 2)
  ...
  heat_layers = heat_layers[heat_layers$day == day_arg, ]
  heat_layers =  heat_layers[heat_layers$year == year_arg, ]
  T_wc = heat_layers$water_temp
  
  tmin_air_data = daily_data[daily_data$district == areas[2], ]
...
```{r}
calculate_phi_e(1, 4, 1, 2017) # (i, place, three_hour, layer_no, day_arg, year_arg)
```


```{r}
calculate_phi_c = function(i, three_hour, day_arg, year_arg){
  # wind speed 2 m above the surface
  daily_data =read_met_data(i, 2)
  wind_speed_2m = daily_data$wind_speed_2m
  W2 = wind_speed_2m
...
```{r}
calculate_phi_c(1, 4, 1, 2017) # (i, place, three_hour, layer_no, day_arg, year_arg)
```
...
```{r}
calculate_phi_dz = function(three_hour, day_arg, year_arg){
  # T_wc is water surface temperature in Celsius
...
```{r}
calculate_and_return_heat_flux_layer_1 = function(i, three_hour, cloud_fraction){
  day_year = find_day_month_and_year(i)
  day_f = day_year$day
  year_f = day_year$year
  ...
  print("phi_sn done")
  print(phi_sn)
  phi_at = calculate_phi_at(three_hour, cloud_fraction, day_f, year_f)
  print("phi_at done")
  print(phi_at)
  phi_ws = calculate_phi_ws(three_hour, day_f, year_f) # (three_hour, day_arg, year_arg)
  print("phi_ws done")
  print(phi_ws)
  phi_e =  calculate_phi_e(i, three_hour, day_f, year_f) # (i, three_hour, day_arg, year_arg)
  print("phi_e done")
  print(phi_e)
  phi_c = calculate_phi_c(i, three_hour, day_f, year_f) # (i, three_hour, day_arg, year_arg)
  print("phi_c done")
  print(phi_c)
  phi_dz = calculate_phi_dz(three_hour, day_f, year_f) # (three_hour, day_arg, year_arg)
  print("phi_dz done")
  print(phi_dz)
  phi_net = phi_sn + phi_at - phi_ws - phi_e + phi_c + phi_dz 
  ...
  air_temp = read.csv("diurnal_air_temp.csv")
  air_temp = air_temp[air_temp$time == hour, ]
  air_temp = air_temp[air_temp$day == day_f, ]  
  air_temp = air_temp[air_temp$year == year_f, ] 
  air_temp = air_temp[air_temp$area == areas[2], ] 
  # Air temperature in degree Celsius
  T_ac = air_temp$air_temp - 273.15
  
  net_heat_and_air_temp = list(phi_sn = phi_sn, phi_at = phi_at, phi_ws = phi_ws, phi_e = phi_e, phi_c = phi_c, phi_dz = phi_dz, phi_net = phi_net, air_temp = T_ac)
  
  return(net_heat_and_air_temp)
}
```


```{r}
flux_values = calculate_and_return_heat_flux_layer_1(1, 4, 0.2)
```

```{r}
(phi_sn_1 = flux_values$phi_sn)
(phi_at_1 = flux_values$phi_at)
(air_temp_1 = flux_values$air_temp)
```



### Simulate pond temperature for layer 1 and save temperature, net heat flux contrent and air temperature

```{r}

simulate_and_save_pond_temperature_for_a_day = function(i, cloud_fraction, sdd){
  ...
  for(j in 1:8){
    if(i==1 & (j== 1 | j==2 | j==3)){
      ...
      day_year = find_day_month_and_year(i-1)
      new_i = i - 1
    } else{
    ...
    net_heat_flux_layer_1 = calculate_and_return_heat_flux_layer_1(new_i, j, cloud_fraction) # calculate_heat_flux_layer_1(i, place, three_hour, cloud_fraction)
    air_temp = net_heat_flux_layer_1$air_temp
    phi_sn = net_heat_flux_layer_1$phi_sn
    phi_at = net_heat_flux_layer_1$phi_at
    phi_ws = net_heat_flux_layer_1$phi_ws
    phi_e = net_heat_flux_layer_1$phi_e
    phi_c = net_heat_flux_layer_1$phi_c
    phi_dz = net_heat_flux_layer_1$phi_dz
    net_heat = net_heat_flux_layer_1$phi_net
    ...
    heat_layer_1 = layer_1$heat + net_heat
    ...
    water_temp = layer_1$water_temp + (heat_layer_1)/(rho_w_1 * c_pw)

    
    # We need to extract the date
    current_day_year = find_day_month_and_year(i)
    day_3 = current_day_year$day
    year_3 = current_day_year$year
    rm(current_day_year) # Remove this dataframe current_day_year
    
    simulated_data = data.frame(time = time_of_the_day[j], day = day_3, year = year_3, air_temp = air_temp, water_temp = water_temp, phi_sn = phi_sn, phi_at = phi_at, phi_ws = phi_ws, phi_e = phi_e, phi_c = phi_c, phi_dz = phi_dz, heat = heat_layer_1)
    # Add data to the CSV file simulated_data_area.csv

    write.table(simulated_data, "simulated_data_for_output.csv", sep = ",", col.names = !file.exists("simulated_data_for_output.csv"), append = T)
...
```{r}
# simulate_and_save_pond_temperature_for_a_day(1, 0.3, 1.0)
```
...
simulate_over_some_days = function(total_days){
  for(i in 1:total_days){
    simulate_and_save_pond_temperature_for_a_day(i, 0.3, 1.0)
  }
}
```

```{r}
simulate_over_some_days(31)
```
...
dd = read.csv("simulated_data_for_output_long.csv")
